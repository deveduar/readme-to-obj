export const readmes = {
  ...
  "todo-app": {
    ...
    "sections": {
      "✨ Características": [
        ...
        "🎯 **Estados y prioridades**: Asignación de estados personalizados y niveles de prioridad.",
        "⏰ **Fechas de vencimiento y recordatorios**: Configura fechas de vencimiento y notificaciones.",
        "📅 **Selección inteligente de fecha y hora**: Asegura que las horas seleccionadas sean válidas según el día elegido.",
        "🔄 **Sincronización con backend**: Persistencia de datos mediante una API."
      ],
      "🛠️ Tecnologías utilizadas": {
        "Frontend": [
          ...
          "🗂 **date-fns** y **date-fns-tz** para manejo de fechas"
        ],
        "Backend (Proyecto separado en GitHub)": [
          "🚀 **Node.js con Express**",
          "🐘 **PostgreSQL** como base de datos",
          "🐳 **Docker** para despliegue y configuración"
        ]
      },
      "🚀 Instalación": {
        "1️⃣ Clonar el repositorio": [
          {
            ...
            "lang": "bash",
            "meta": null,
            "value": "git clone https://github.com/tu-usuario/tu-repo-todo.git\ncd tu-repo-todo"
          }
        ],
        ...
        "3️⃣ Configurar el backend (Docker)": [
          "El backend está en un proyecto separado en GitHub. Sigue sus instrucciones para configurarlo con Docker."
        ],
  ...
  "nextjs-blog": {
    "title": "Deveduar Blog",
    "url": "https://raw.githubusercontent.com/deveduar/nextjs-blog/main/README.md",
    "sections": {
      "Description:": [
  ...
  "booking-app": {
    ...
    "url": "https://raw.githubusercontent.com/deveduar/booking-app/master/README.md",
    "sections": {
  ...
  "inventory-backend": {
    ...
    "url": "https://raw.githubusercontent.com/deveduar/inventory-backend/main/README.md",
    "sections": {}
  },
  "portfolio-3d": {
    "title": "portfolio-3d",
    "url": "https://raw.githubusercontent.com/deveduar/portfolio-3d/main/README.md",
    "sections": {}
  },
